...
function changeBackground(date) {
  ...
  if (month == 0 || month == 1 || month == 11) {
    document.body.style.background = 'url("/src/image/winter.jpg")';
  } else if (month == 2 || month == 3 || month == 4) {
    document.body.style.background = 'url("/src/image/spring.jpg")';
  } else if (month == 5 || month == 6 || month == 7) {
    document.body.style.background = 'url("//src/image/summer1.jpg")';
  } else {
    document.body.style.background = 'url("/src/image/Fall1.jpg")';
  }
}
